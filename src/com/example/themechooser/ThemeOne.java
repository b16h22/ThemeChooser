...
public class ThemeOne extends Activity {
	...
	protected void showDialog(){
		...
		AlertDialog.Builder alertDialog = new AlertDialog.Builder(ThemeOne.this);		 
        alertDialog.setTitle("Apply");
        alertDialog.setMessage("You are going to apply Theme 1. Your device will reboot after applying the theme");
	...
	protected void goToThemeChooser(){
        ...
        alertDialog.setMessage("You are going to open Theme chooser. Please select Theme 1 from there and reboot");
	...
	protected void progressDialog(){
		pd = new ProgressDialog(ThemeOne.this);
